...
import { getPointerInfo } from '@app/utils/whiteboard/getpointerinfo';
export const INDENT = '  ';
export const stopEventPropagation = (e: any) => e.stopPropagation();

export function useQuillTextEditing<
  T extends Extract<TLShape, { props: { text: string } }>
>(id: T['id'], type: string, text: string) {
    ...
    (e: React.ChangeEvent<HTMLTextAreaElement>) => {
      ...
      if (untabbedText !== text) {
        ...
        e.currentTarget.selectionStart =
          selectionStart + (untabbedText.length - text.length);
