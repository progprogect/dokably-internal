...
import { mindMapSquareArrowProps } from './props';
...
import { isAncestorSelected } from '@app/utils/whiteboard/common';
...
export class MindMapSquareArrowUtil extends ShapeUtil<IMindMapSquareArrow> {
  static override type = MIND_MAP_SQUARE_ARROW_SHAPE_ID;
  static override props = mindMapSquareArrowProps;

  override isAspectRatioLocked = (_shape: IMindMapSquareArrow) => true;
  override canResize = (_shape: IMindMapSquareArrow) => false;

  override canCrop = () => false;
  override canEdit = () => false;
  override canBind = () => false;
  override canSnap = () => false;
  override hideResizeHandles: TLShapeUtilFlag<IMindMapSquareArrow> = () => true;
  override hideRotateHandle: TLShapeUtilFlag<IMindMapSquareArrow> = () => true;
  override hideSelectionBoundsBg: TLShapeUtilFlag<IMindMapSquareArrow> = () =>
    true;
  override hideSelectionBoundsFg: TLShapeUtilFlag<IMindMapSquareArrow> = () =>
    true;

  override getDefaultProps(): IMindMapSquareArrow['props'] {
    return {
  ...
  onHandleDrag: TLOnHandleDragHandler<IMindMapSquareArrow> = () => {
  };

  override onTranslateStart: TLOnTranslateStartHandler<IMindMapSquareArrow> = () => {
  };

  getGeometry(shape: IMindMapSquareArrow) {
  ...
  component(shape: IMindMapSquareArrow) {
    useEffect(() => {
  ...
  indicator(shape: IMindMapSquareArrow) {
    return;
  }

  onClick?: TLOnClickHandler<IMindMapSquareArrow> | undefined = () => {
  };

  override onResize: TLOnResizeHandler<IMindMapSquareArrow> = () => {
  };

  override getHandles(shape: IMindMapSquareArrow): TLHandle[] {
    return [];
  }
}
...
function computePathString({
 ...
 linePath += `${xAnchor1},${yAnchor1} C${xAnchor2},${yAnchor2} ${xAnchor2},${yAnchor2} `;
...
export function getStraightArrowInfo(
  ...
  if (!isSelfIntersection) {
    if (
      ...
      const startShape = startShapeInfo.shape as IMindMapSquareArrow;
    ...
    if (
      ...
      const endShape = endShapeInfo.shape as IMindMapSquareArrow;
