...
import { customSquareArrowProps } from './custom-square-arrow-props';
...
export class CustomSquareArrowUtil extends ShapeUtil<ICustomSquareArrow> {
  static override type = CUSTOM_SQUARE_ARROW_SHAPE_ID;
  static override props = customSquareArrowProps;

  override canEdit = () => true;
  override canBind = () => false;
  override canSnap = () => false;
  override hideResizeHandles: TLShapeUtilFlag<ICustomSquareArrow> = () => true;
  override hideRotateHandle: TLShapeUtilFlag<ICustomSquareArrow> = () => true;
  override hideSelectionBoundsBg: TLShapeUtilFlag<ICustomSquareArrow> = () => true;
  override hideSelectionBoundsFg: TLShapeUtilFlag<ICustomSquareArrow> = () => true;

  override getDefaultProps(): ICustomSquareArrow['props'] {
    return {
  ...
  getGeometry(shape: ICustomSquareArrow) {
  ...
  override getHandles(shape: ICustomSquareArrow): TLHandle[] {
    const info = getStraightArrowInfo(this.editor, shape)!;
    return [
      {
        id: 'start',
	...
	override onHandleDrag: TLOnHandleDragHandler<ICustomSquareArrow> = (shape, { handle, isPrecise }) => {
		...
		const next = structuredClone(shape) as ICustomSquareArrow
  ...
  override onTranslateStart: TLOnTranslateStartHandler<ICustomSquareArrow> = (shape) => {
  ...
  override onTranslate?: TLOnTranslateHandler<ICustomSquareArrow> = (initialShape, shape) => {
  ...
  component(shape: ICustomSquareArrow) {
  ...
  indicator(shape: ICustomSquareArrow) {
  ...
  override onDoubleClickHandle = (
    shape: ICustomSquareArrow,
    handle: TLHandle
  ): TLShapePartial<ICustomSquareArrow> | void => {
    switch (handle.id) {
      case 'start': {
        return {
          id: shape.id,
  ...
  override onResize: TLOnResizeHandler<ICustomSquareArrow> = (
    shape,
    info
  ) => {
...
export function getStraightArrowInfo(
  ...
  if (!isSelfIntersection) {
    if (
      ...
      const startShape = startShapeInfo.shape as ICustomSquareArrow;
    ...
    if (
      ...
      const endShape = endShapeInfo.shape as ICustomSquareArrow;
