...
import { BannerAnchorMenu } from './BannerAnchorMenu';
...
const BannerDndWrapper = (props: Props) => {
  ...
  const { portalId } = useMemo(() => {
    ...
    return { portalId: `portal-${blockKey}` };
  }, [props.block]);
    ...
    >
      ...
      {anchorMenuIsOpen &&
        ReactDOM.createPortal(
          <div
            style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', zIndex: 3, cursor: 'pointer' }}
...
export default BannerDndWrapper;
